      ...
      <>
        ...
        <div className="popup_innerContainer_inputContainer_div1">
          <Input
            ...
            defaultValue={
              this.props.data &&
              moment(this.props.data.travel_date[i]).format('YYYY-MM-DD')
            }
            className="input inputs"
      ...
      <div className="popup">
        <div className="popup_innerContainer">
          ...
          <div className="popup_innerContainer_inputContainer">
            ...
            {this.state.checked === 'multiCity' && (
              <button type="button" onClick={this.incrementInputs}>
                Add
              </button>
            )}
            {(this.state.checked === 'multiCity' ||
              this.state.checked === 'returnTrip') && (
              <>
                <div className="popup_innerContainer_inputContainer_text">
                  <label className="popup_innerContainer_inputContainer_text_texts">
                    Return Date
                ...
                <div className="popup_innerContainer_inputContainer_div1">
                  ...
                  <Input
                    ...
                    defaultValue={
                      this.props.data &&
                      moment(this.props.data.return_date).format('YYYY-MM-DD')
                    }
                    className="input inputs"
