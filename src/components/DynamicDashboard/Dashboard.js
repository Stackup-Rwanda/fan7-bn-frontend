...
class Dashboard extends Component {
  ...
  render() {
    ...
    const side = !!links ? links.map(menu =>       
      <li>
    ...
    return (
        ...
        <ul className="dynamic_sidebar_main">
          <li>
            <NavLink to="/dashboard" className="dynamic_sidebar_main_component1">
              <img src={dashboard} alt="dashboard" className="dynamic_sidebar_main_component1_icon" />
        ...
        <ul className="dynamic_sidebar_bottom">
          <li>
            <NavLink to="/profile" className="dynamic_sidebar_bottom_component">
              <img src={account} alt="account" className="dynamic_sidebar_bottom_component_icon" />
              <p className="dynamic_sidebar_bottom_component_text">Account</p>
              <img src={forward} alt="forward" className="dynamic_sidebar_bottom_component_image" />
            </NavLink>
          </li>
          <li>
            <Link to="/login" className="dynamic_sidebar_bottom_component">
              <img src={signout} alt="signout" className="dynamic_sidebar_bottom_component_icon" />
      ...
      <div className="dynamic_navbar">
        ...
        <ul className="dynamic_navbar_items">
          <li>
            <img src={notification} alt="notifications" className="dynamic_navbar_items_single" />
          </li>
          <li>
            <img src={this.props.profile} alt="profile" className="dynamic_navbar_items_single2" />
          </li>
        </ul>
      </div>
